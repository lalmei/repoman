...
class TestGitUserFunctions:
    ...
    def test_git_user_name_with_valid_output(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_name_with_empty_output(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_name_with_whitespace_output(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_email_with_valid_output(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_email_with_empty_output(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_email_with_whitespace_output(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_name_with_subprocess_error(self, mock_getoutput):
    ...
    @patch("subprocess.getoutput")
    def test_git_user_email_with_subprocess_error(self, mock_getoutput):
...
class TestSlugifyFunction:
    ...
    def test_slugify_with_mixed_separators(self):
    ...
    def test_slugify_with_empty_string(self):
        """Test slugify with empty string."""
        result = slugify("")
        assert result == ""

    def test_slugify_with_whitespace_only(self):
...
class TestGitExtension:
    ...
    def test_git_extension_initialization(self):
    ...
    def test_git_extension_filters_in_template(self, mock_git_email, mock_git_name):
...
class TestSlugifyExtension:
    ...
    def test_slugify_extension_initialization(self):
    ...
    def test_slugify_extension_filter_in_template(self):
    ...
    def test_slugify_extension_filter_with_custom_separator(self):
...
class TestCurrentYearExtension:
    ...
    def test_current_year_extension_initialization(self):
        """Test CurrentYearExtension initialization."""
        env = Environment()
        extension = CurrentYearExtension(env)

        assert "current_year" in env.globals
        assert env.globals["current_year"] == date.today().year

    def test_current_year_extension_global_in_template(self):
    ...
    def test_current_year_extension_math_operations(self):
        ...
        assert result == f"Next year: {date.today().year + 1}"


class TestExtensionsIntegration:
    """Test multiple extensions working together."""

    def test_multiple_extensions_in_single_environment(self):
    ...
    @patch("repoman.extensions.git_user_name")
    def test_multiple_extensions_in_template(self, mock_git_name):
...
class TestExtensionsErrorHandling:
    ...
    def test_git_extension_with_subprocess_error(self):
    ...
    def test_slugify_extension_with_invalid_input(self):
    ...
    def test_current_year_extension_consistency(self):
