...
The repoman project has strict rules for AI usage:
...
These rules apply only to outside contributions to repoman. Maintainers
...
Please remember that repoman is maintained by humans.
